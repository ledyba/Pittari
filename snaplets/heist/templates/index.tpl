...
<h2>画像をぴったりサイズで印刷しよう</h2>
<p>画像をセンチメートル単位で指定したサイズに印刷するためのpdfファイルを作ってくれるサービスです。</p>
<p>コンビニや学校の共用プリンタでも、サイズをぴったり指定して画像を印刷できます。</p>
...
<p>生成されたPDFは<a href="http://www.printing.ne.jp/">セブンイレブンのネットプリント</a>に対応しています（2014年2月現在）。他のコンビニでも対応しているかもしれませんが、わかりません。</p>
<p>ダウンロードしたPDFを登録してお店で印刷すると、指定したサイズで画像を印刷できます。「原寸出力」を必ず選んで下さい。</p>
<h2>参考サイズ</h2>

<p><strong><a href="https://xn--uny097c.circle.ms/html/cuttemp/comike_temp.html">コミケのサークルカット</a></strong>は、横4cm 縦5.7cmです（C86での情報）。</p>
...
<h2>Powerd by</h2>
<p>このアプリは<a href="http://snapframework.com/">Snap: A Haskell Web Framework</a>で構築されています。</p>
<p>ソースコードは<a href="https://github.com/ledyba/Pittari-Kun/">githubで公開しています</a>。</p>
</apply>
